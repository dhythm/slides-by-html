...
`layouts/layout-patterns.html` に収録された68種類のパターン：

| カテゴリ             | パターン数 | 主なパターン                                     |
| -------------------- | :--------: | ------------------------------------------------ |
| 構成・導入系         |     6      | 表紙、ヒーロー表紙、アジェンダ、セクション扉     |
| 紹介系               |     2      | 会社紹介、製品・サービス紹介                     |
| 基本文字レイアウト   |     8      | 2カラム、3カラム、大見出し+補足、引用、FAQ       |
| 比較・整理系         |     8      | 左右比較、SWOT、ベン図、課題→原因→打ち手         |
| 流れ・時間軸系       |     7      | ステップ、シェブロン、タイムライン、ロードマップ |
| データ・分析系       |     17     | KPI、棒グラフ、折れ線、ドーナツ、ガントチャート  |
| 画像・プロダクト系   |     6      | 全画面画像、スクリーンショット+注釈              |
| 人・組織・信頼形成系 |     5      | チーム紹介、組織図、顧客の声                     |
| 締め・補足系         |     7      | まとめ、CTA、Thank You、参考文献                 |
| 装飾コンポーネント   |     2      | パネルデザイン、カード・タグ・バッジ             |
